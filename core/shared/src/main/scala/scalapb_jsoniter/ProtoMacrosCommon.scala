...
// Vendored (trimmed to the ToExpr instances scalapb-jsoniter uses) from
// scalapb-json-macros (io.github.scalapb-json) so the macros module can compile
// against scalapb-runtime 1.0.0-alpha.x, which upstream does not yet target.
